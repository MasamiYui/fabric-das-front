...
public class Photo {
    ...
    public Photo(String id, String title, String des, String ownerId, String author, String files, String filesHash, String transactionId, String submitTime, String state) {
        this.id = id;
        this.title = title;
        this.des = des;
