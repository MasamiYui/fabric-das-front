...
public class PDFTemplate {
    ...
    public static String generateDegreeCertification(HashMap degreeCertificateMap, String QRText) throws IOException, DocumentException {
     ...
     /*   //学历证书模板路径
        ...
        String templatePath = PDFTemplate.class.getResource("/").getPath()+"pdf/"+"type1.pdf";
        templatePath = templatePath.substring(1, templatePath.length());//TODO linux下可能不需要
        System.out.println(templatePath);
        ...
        form.setField("assetType", "学位证书");
        form.setField("assetId", degreeCertificateMap.get("id").toString());
        form.setField("owner", degreeCertificateMap.get("ownerName")+"("+degreeCertificateMap.get("ownerId").toString()+")");
        form.setField("certId",degreeCertificateMap.get("certId").toString());
        form.setField("fileshash", degreeCertificateMap.get("filesHash").toString().replace(",","\n"));
        form.setField("transactionId", degreeCertificateMap.get("transactionId").toString());
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));
        form.setField("year", String.valueOf(c.get(Calendar.YEAR)));
        form.setField("month", String.valueOf(c.get(Calendar.MONTH) + 1));
    ...
    public static String generateMusic(HashMap musicMap, String QRText) throws IOException, DocumentException {
        ...
        form.setField("owner", musicMap.get("ownerName")+"("+musicMap.get("ownerId").toString()+")");
        form.setField("title",musicMap.get("title").toString());

        form.setField("author",musicMap.get("author").toString().replaceAll(","," "));
    ...
    public static String generateVideo(HashMap videoMap, String QRText) throws IOException, DocumentException {
        ...
        form.setField("owner", videoMap.get("ownerName")+"("+videoMap.get("ownerId").toString()+")");
        form.setField("title",videoMap.get("title").toString());
        form.setField("author",videoMap.get("author").toString().replaceAll(","," "));
    ...
    public static String generateImage(HashMap imageMap, String QRText) throws IOException, DocumentException {
        ...
        form.setField("assetId", imageMap.get("id").toString());
        form.setField("owner", imageMap.get("ownerName")+"("+imageMap.get("ownerId").toString()+")");
        form.setField("title",imageMap.get("title").toString());
        form.setField("author",imageMap.get("author").toString().replaceAll(","," "));
        form.setField("fileshash", imageMap.get("filesHash").toString().replace(",","\n"));
        form.setField("transactionId", imageMap.get("transactionId").toString());
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));
        form.setField("year", String.valueOf(c.get(Calendar.YEAR)));
        form.setField("month", String.valueOf(c.get(Calendar.MONTH) + 1));
        form.setField("day", String.valueOf(c.get(Calendar.DAY_OF_MONTH)));
    ...
    public static String generateDrivingLicence(HashMap drivingLicenceMap, String QRText) throws IOException, DocumentException {
        ...
        //表单处理
        form.setField("assetType", "机动车驾驶证");
        form.setField("assetId", drivingLicenceMap.get("id").toString());
        form.setField("owner", drivingLicenceMap.get("ownerName")+"("+drivingLicenceMap.get("ownerId").toString()+")");
        form.setField("certId",drivingLicenceMap.get("drivingLicenceId").toString());
        form.setField("fileshash", drivingLicenceMap.get("filesHash").toString().replace(",","\n"));
        form.setField("transactionId", drivingLicenceMap.get("transactionId").toString());
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));
        form.setField("year", String.valueOf(c.get(Calendar.YEAR)));
        form.setField("month", String.valueOf(c.get(Calendar.MONTH) + 1));
        form.setField("day", String.valueOf(c.get(Calendar.DAY_OF_MONTH)));
    ...
    public static String generateSyxxzl(HashMap syxxzlMap, String QRText) throws IOException, DocumentException {
        ...
        form.setField("fileshash", syxxzlMap.get("filesHash").toString().replace(",","\n"));
        form.setField("transactionId", syxxzlMap.get("transactionId").toString());
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));
        form.setField("year", String.valueOf(c.get(Calendar.YEAR)));
        form.setField("month", String.valueOf(c.get(Calendar.MONTH) + 1));
        form.setField("day", String.valueOf(c.get(Calendar.DAY_OF_MONTH)));
